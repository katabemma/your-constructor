<div class="btn-group portfolio-portfolio">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[title]" class="col-sm-2 control-label">
                                        {!! trans('portfolio::portfolio.label.title')!!}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[category_id]" class="col-sm-2 control-label">
                                        {!! trans('portfolio::portfolio.label.category_id')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::select('search[category_id]')
                                         ->options([''=>'All']+Portfolio::selectCategories())
                                        ->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[published]" class="col-sm-2 control-label">
                                        {!! trans('portfolio::portfolio.label.published')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::select('search[published]')
                                         -> options([''=>'All']+trans('portfolio::portfolio.options.published'))
                                         ->raw()!!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label for="search[status]" class="col-sm-2 control-label">
                                        {!! trans('portfolio::portfolio.label.status')!!}
                                    </label>
                                    <div class="col-sm-10">
                                        {!! Form::select('search[status]')
                                         -> options([''=>'All']+trans('portfolio::portfolio.options.status'))
                                         ->raw()!!}
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".portfolio-portfolio .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/portfolio.portfolio.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".portfolio-portfolio .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.portfolio-portfolio .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'portfolio.portfolio.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#portfolio-portfolio-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#portfolio-portfolio-list .btn-reset-filter').css('display', 'none');
